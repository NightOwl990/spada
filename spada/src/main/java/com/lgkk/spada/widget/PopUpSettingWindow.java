...
public class PopUpSettingWindow extends PopupWindow {
    ...
    public PopUpSettingWindow(final Activity activity) {
        mActivity = activity;
        ...
        int width = (int) activity.getResources().getDimension(R.dimen.length_100);
        int height = (int) activity.getResources().getDimension(R.dimen.length_50);
        setWidth(width);
        setHeight(height);
