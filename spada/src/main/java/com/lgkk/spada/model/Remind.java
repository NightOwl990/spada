...
public class Remind implements Comparable<Remind> {
    ...
    public Remind(long mId, String mTitle, long mDate, boolean mEnabled, boolean mNotification, int mOccurence, int mDays, long mNextOccurence, String mContent) {
        this.mId = mId;
        this.mTitle = mTitle;
        this.mDate = mDate;
        this.mEnabled = mEnabled;
        this.mNotification = mNotification;
        this.mOccurence = mOccurence;
        this.mDays = mDays;
        this.mNextOccurence = mNextOccurence;
    ...
    public int compareTo(Remind aThat) {
    ...
    public void toIntent(Intent intent) {
        ...
        intent.putExtra("com.taradov.alarmme.notifi", mNotification);
        intent.putExtra("com.taradov.alarmme.occurence", mOccurence);
        intent.putExtra("com.taradov.alarmme.days", mDays);
        intent.putExtra("com.taradov.alarmme.contents", mContent);
    }

    public void fromIntent(Intent intent) {
        mId = intent.getLongExtra("com.taradov.alarmme.id", 1);
        ...
        mNotification = intent.getBooleanExtra("com.taradov.alarmme.notifi", true);
        mOccurence = intent.getIntExtra("com.taradov.alarmme.occurence", 0);
        mDays = intent.getIntExtra("com.taradov.alarmme.days", 0);
        mContent = intent.getStringExtra("com.taradov.alarmme.contents");
        update();
    }
