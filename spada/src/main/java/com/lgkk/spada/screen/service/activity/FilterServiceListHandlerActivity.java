...
public class FilterServiceListHandlerActivity extends FilterServiceListActivity implements PopUpFilterTabClickListener, OnCustomViewClickListener {
    ...
    protected void settingPopupView() {
        categoryProductRvView = new CategoryProductRvView(this, serviceDetailList);
        categoryProductRvView.setListener(this);
        popupFilterMenu.setListener(this);
        headers = getResources().getStringArray(R.array.filter_tab_service);
...
//        popupViews.add(filterPlaceView);
        ...
        popupFilterMenu.initPopupMenu(Arrays.asList(headers), popupViews, categoryProductRvView);
