...
public class FilterLinearAdapter extends BaseQuickAdapter<FilterTypeDetail, BaseViewHolder> {
    public List<FilterTypeDetail> list;
    private Context context;
    OnItemRvClickListener onItemRvClickListener;


    public FilterLinearAdapter(Context context, List<FilterTypeDetail> data, OnItemRvClickListener onItemRvClickListener) {
        super(R.layout.item_filter_linear, data);
