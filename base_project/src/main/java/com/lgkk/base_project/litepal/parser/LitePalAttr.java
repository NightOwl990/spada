...
package com.lgkk.base_project.litepal.parser;

import java.util.ArrayList;
import java.util.List;

import com.lgkk.base_project.litepal.exceptions.InvalidAttributesException;
...
public final class LitePalAttr {
	...
	public List<String> getClassNames() {
		if (classNames == null) {
			...
			classNames.add("com.lgkk.base_project.litepal.model.Table_Schema");
	 ...
	 * 
	 * @throws com.lgkk.base_project.litepal.exceptions.InvalidAttributesException
	 */
