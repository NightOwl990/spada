...
package com.lgkk.base_project.litepal.tablemanager;
...
import com.lgkk.base_project.litepal.util.LitePalLog;
 ...
 * {@link com.lgkk.base_project.litepal.tablemanager.AssociationUpdater}. So this class just deal with the simple job of
...
public abstract class AssociationUpdater extends Creator {
	...
	/**
	 * Analysis the {@link com.lgkk.base_project.litepal.tablemanager.model.TableModel} by the purpose of subclasses, and
	...
	/**
	 * {@link com.lgkk.base_project.litepal.tablemanager.AssociationUpdater} does two jobs. Removing foreign key columns
	 ...
	 * only used in {@link #findForeignKeyToRemove(com.lgkk.base_project.litepal.tablemanager.model.TableModel)} when iterating
	...
	/**
	 * Judge if the tableName1 equals {@link com.lgkk.base_project.litepal.tablemanager.model.AssociationsModel#getTableName()}
	 * and tableName2 equals {@link com.lgkk.base_project.litepal.tablemanager.model.AssociationsModel#getAssociatedTableName()}.
	 * 
