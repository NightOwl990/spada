...
public class SaveHandler extends DataHandler {
    ...
    /**
	 * Initialize {@link com.lgkk.base_project.litepal.crud.DataHandler#mDatabase} for operating database. Do not
	 ...
	 * {@link com.lgkk.base_project.litepal.Operator#saveAll(java.util.Collection)}. Each model in the collection
