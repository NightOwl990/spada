...
//    String BASE_RETROFIT_API_URL = BASE_API_URL + "/api/";
    ...
    String GETDATA_URL = "http://private-amnesiac-cec6fa-longnguyen5.apiary-proxy.com/";
    ...
    int REQUEST_ALBUM = 1;
    int REQUEST_CORP = 2;
    public static final String[] USE_DEJA_FONT_LANGUAGE_CODES = {};
    int DEFAULT_RANGE_FLASH_HOUR = 4;
    String CURRENT_LAT = "currentLat";
    String CURRENT_LNG = "currentLng";
    String CURRENT_CITY_ID = "currentCityId";
    String BASE_REQUEST = "base_request";
