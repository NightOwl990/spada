package com.lgkk.base_project._network.helper;
...
import com.lgkk.base_project.BuildConfig;

import com.lgkk.base_project.base.Constants;
import com.lgkk.base_project._network.support.Logger;
import com.lgkk.base_project.utils.AppUtils;
import com.lgkk.base_project.utils.FileUtils;
    ...
    private static class UserAgentInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            Request requestWithUserAgent = originalRequest.newBuilder()
                    ...
                    .addHeader("User-Agent", Constants.COMMON_UA_STR)
                    .build();
