...
public class SystemToast implements IToast {
    ...
    public static SystemToast makeText(@NonNull Context context, @NonNull String text, @UniversalToast.Duration int
        ...
        if (type == UniversalToast.EMPHASIZE) {
    ...
    @Override
    public void show() {
        ImageView imgIcon = mToast.getView().findViewById(R.id.icon);
        if (mLeftGifUri != null) {
    ...
    public void showSuccess() {
        setLeftIconRes(mType == UniversalToast.EMPHASIZE ? R.drawable.ic_check_circle_white_24dp : R.drawable.ic_done_white_24dp);
        show();
    }
