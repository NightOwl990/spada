...
import com.lgkk.base_project.utils.LiveNetworkUtils;
...
public class NetworkService extends Service {
    ...
    private void networkBroadCast(Context context, Intent intent, int netState) {
        intent.setAction(LiveNetworkUtils.NET_BROADCAST_ACTION);
        intent.putExtra(LiveNetworkUtils.NET_STATE_NAME, netState);
