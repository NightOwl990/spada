...
public class ViewSkeletonScreen implements SkeletonScreen {
    ...
    private OnSkeletonViewClickListener onSkeletonViewClickListener;

    private ViewSkeletonScreen(Builder builder) {
        mActualView = builder.mView;
        onSkeletonViewClickListener = builder.onSkeletonViewClickListener;
    ...
    private ShimmerLayout generateShimmerContainerLayout(ViewGroup parentView) {
        ...
        if (mSkeletonResID == R.layout.common_error_view || mSkeletonResID == R.layout.common_empty_view) {
            TextView btnRefresh = innerView.findViewById(R.id.page_tip_eventview);
            btnRefresh.setOnClickListener(v -> onSkeletonViewClickListener.onSkeletonViewClick(v));
        } else if (mSkeletonResID == R.layout.common_error_view || mSkeletonResID == R.layout.common_empty_post_view) {
            TextView btnGoBack = innerView.findViewById(R.id.btnGoBack);
            btnGoBack.setOnClickListener(v -> onSkeletonViewClickListener.onSkeletonViewClick(v));
        }
    ...
    public static class Builder {
         ...
         */
        public Builder load(@LayoutRes int skeletonLayoutResID, OnSkeletonViewClickListener onSkeletonViewClickListener) {
            this.onSkeletonViewClickListener = onSkeletonViewClickListener;
