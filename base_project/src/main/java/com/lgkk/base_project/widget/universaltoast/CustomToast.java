package com.lgkk.base_project.widget.universaltoast;
...
import com.lgkk.base_project.widget.universaltoast.UniversalToast.Duration;
import com.lgkk.base_project.widget.universaltoast.UniversalToast.Type;
import com.lgkk.base_project.utils.ImageUtils;

import static android.os.Build.VERSION_CODES.JELLY_BEAN;
import static android.os.Build.VERSION_CODES.JELLY_BEAN_MR1;
import static com.lgkk.base_project.widget.universaltoast.UniversalToast.CLICKABLE;
import static com.lgkk.base_project.widget.universaltoast.UniversalToast.EMPHASIZE;
import static com.lgkk.base_project.widget.universaltoast.UniversalToast.UNIVERSAL;
    ...
    public void show() {
        ...
        mShowRunnable = new Runnable() {
            ...
            public void run() {
                ...
                ImageView imgIcon = mView.findViewById(R.id.icon);
                if (mLeftGifUri != null) {
                    ImageUtils.loadImageByGlide(mContext, mLeftGifUri.toString(), imgIcon);
                } else if (mLeftIconRes != NO_LEFT_ICON) {
                    ImageUtils.loadImageDrawableByGlide(mContext, mLeftIconRes, imgIcon);
                }
