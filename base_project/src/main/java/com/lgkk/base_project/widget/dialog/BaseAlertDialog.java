...
import com.lgkk.base_project.widget.FlipVerticalSwingEnterDialog.BaseDialog;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
     ...
     * btn text(按钮内容)
     */
    protected String mBtnLeftText = "Hủy";
    protected String mBtnRightText = "Đồng ý";
    protected String mBtnMiddleText = "Đồng ý";
    /**
    ...
    public String getmBtnMiddleText() {
        return mBtnMiddleText;
    }

    public void setmBtnMiddleText(String mBtnMiddleText) {
        this.mBtnMiddleText = mBtnMiddleText;
    }
    ...
    public void setUiBeforShow() {
        ...
        mTvTitle.setText(TextUtils.isEmpty(mTitle) ? "Thông báo" : mTitle);
