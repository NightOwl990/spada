package com.lgkk.base_project.widget.datepicker;
...
import com.lgkk.base_project.utils.LogUtils;
...
public class DateTimePicker extends WheelPicker {
    ...
    private String yearLabel = "năm", monthLabel = "tháng", dayLabel = "ngày";
    private String hourLabel = "giờ", minuteLabel = "phút";
    ...
    protected View makeCenterView() {
        ...
        if (dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) {
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(0, WRAP_CONTENT, 1.0f);
            layoutParams.setMargins(0, 0, 0, (int) getContext().getResources().getDimension(R.dimen.length_15));
