package com.lgkk.base_project.widget.flycotablayout;
...
//        ImageUtils.loadImageDrawableByGlide(mContext, mTabEntitys.get(position).getTabUnselectedIcon(), iv_tab_icon);
...
//            ImageUtils.loadImageDrawableByGlide(mContext, i == mCurrentTab ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon(), iv_tab_icon);
...
final boolean isSelect = i == position;
        ...
        ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
        CustomTabEntity tabEntity = mTabEntitys.get(i);
//        ImageUtils.loadImageDrawableByGlide(mContext, isSelect ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon(), iv_tab_icon);
...
class IndicatorPoint {
    ...
    private CommonTabLayout.IndicatorPoint mCurrentP = new CommonTabLayout.IndicatorPoint();
    private CommonTabLayout.IndicatorPoint mLastP = new CommonTabLayout.IndicatorPoint();

class PointEvaluator implements TypeEvaluator<CommonTabLayout.IndicatorPoint> {
    @Override
    public CommonTabLayout.IndicatorPoint evaluate(float fraction, CommonTabLayout.IndicatorPoint startValue, CommonTabLayout.IndicatorPoint endValue) {
        float left = startValue.left + fraction * (endValue.left - startValue.left);
        float right = startValue.right + fraction * (endValue.right - startValue.right);
        CommonTabLayout.IndicatorPoint point = new CommonTabLayout.IndicatorPoint();
        point.left = left;
        point.right = right;
        return point;
    }
