package com.lgkk.base_project.widget.flowTextView;
...
import com.lgkk.base_project.widget.flowTextView.helpers.ClickHandler;
import com.lgkk.base_project.widget.flowTextView.helpers.CollisionHelper;
import com.lgkk.base_project.widget.flowTextView.helpers.PaintHelper;
import com.lgkk.base_project.widget.flowTextView.helpers.SpanParser;
import com.lgkk.base_project.widget.flowTextView.listeners.OnLinkClickListener;
import com.lgkk.base_project.widget.flowTextView.models.HtmlLink;
import com.lgkk.base_project.widget.flowTextView.models.HtmlObject;
import com.lgkk.base_project.widget.flowTextView.models.Line;
import com.lgkk.base_project.widget.flowTextView.models.Obstacle;
...
public class FlowTextView extends RelativeLayout {
    ...
    private float mTextsize = getResources().getDimension(R.dimen.length_14);
    private int mTextColor = getResources().getColor(R.color.text_main);
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        mTextColor = ta.getColor(3, getResources().getColor(R.color.text_main)); // 3 is the index of the array of the textColor attribute
        ta.recycle();
    }
