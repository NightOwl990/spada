package com.lgkk.base_project.widget.verticalbanner;
...
import com.lgkk.base_project.widget.verticalbanner.callback.CreateViewCaller;
import com.lgkk.base_project.widget.verticalbanner.core.BaseBanner;
import com.lgkk.base_project.widget.verticalbanner.pager.RecyclerViewPager;
...
//        mRecyclerView.setLongClickable(true);
    ...
    private void runDirection(RecyclerViewPager mRecyclerView) {
        ...
        if (isVertical) {
            mRecyclerView.setLayoutManager(new SpeedScrollLinearLayoutManager(getContext(), SpeedScrollLinearLayoutManager.VERTICAL, false));
        } else {
            mRecyclerView.setLayoutManager(new SpeedScrollLinearLayoutManager(getContext(), SpeedScrollLinearLayoutManager.HORIZONTAL, false));
        }
    }
...
//           RecyclerView.ViewHolder.setPosition(holder, position);
        }
