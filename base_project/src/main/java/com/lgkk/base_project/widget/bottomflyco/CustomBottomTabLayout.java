//package com.lgkk.base_project.ui.widget.bottomflyco;
//
...
//import FragmentChangeManager;
//import MsgView;
//import OnTabSelectListener;
//import UnreadMsgUtils;
//
//
//import java.util.ArrayList;
//
//public class CustomBottomTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
...
//    }
//
//    public CustomBottomTabLayout(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//    }
//
//    public CustomBottomTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CustomBottomTabLayout);
//
...
//
//                tabView = LayoutInflater.from(mContext).inflate(R.layout.bottom_tab_layout, this, false);
...
//
////        Logs.d("AAA", "mLastP--->" + mLastP.left + "&" + mLastP.right);
////        Logs.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
