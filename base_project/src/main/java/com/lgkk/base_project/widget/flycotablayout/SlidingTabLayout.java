...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity fa, ArrayList<androidx.fragment.app.Fragment> fragments) {
        if (vp == null) {
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    class InnerPagerAdapter extends FragmentPagerAdapter {
        private ArrayList<androidx.fragment.app.Fragment> fragments = new ArrayList<>();
        private String[] titles;

        public InnerPagerAdapter(FragmentManager fm, ArrayList<androidx.fragment.app.Fragment> fragments, String[] titles) {
            super(fm);
