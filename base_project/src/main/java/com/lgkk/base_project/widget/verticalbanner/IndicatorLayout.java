...
import com.lgkk.base_project.widget.verticalbanner.core.IndicatorAble;
...
public class IndicatorLayout extends LinearLayout implements IndicatorAble {
    ...
    private void dealAttrs(AttributeSet attrs) {
        ...
        mMinDotCount = typedArray.getInt(R.styleable.IndicatorLayout_il_indicator_min_dot, mMinDotCount);
        mMaxDotCount = typedArray.getInt(R.styleable.IndicatorLayout_il_indicator_max_dot, mMaxDotCount);
