...
import com.lgkk.base_project.widget.NetworkService;
...
public class LiveNetworkUtils {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                switch (CURRENT_NETWORK_STATE) {
                    case -1:
                        ToastUtils.showSingleLongToast("Mạng chưa kết nối.");
                        setOnChangeInternet(false);//设置网络监听
                        LogUtils.i(TAG, "Mạng thay đổi thành không có mạngCURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
                    case 1:
                        setOnChangeInternet(true);//设置网络监听
                        LogUtils.i(TAG, "Mạng đổi thành mạng WIFI  CURRENT_NETWORK_STATE=" + CURRENT_NETWORK_STATE);
                        break;
                    case 2:
                        setOnChangeInternet(true);//设置网络监听
                        LogUtils.i(TAG, "Mạng đổi thành mạng di động CURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
                    default:
                        break;
                }
    ...
    public enum NetType {
        None(1, "Không có kết nối mạng"),
        Mobile(2, "Mạng Mobile di động"),
        Wifi(4, "Mạng Wifi"),
        Other(8, "Mạng không xác định");
