...
import com.lgkk.base_project.base.RxxBus.ApiException;
import com.lgkk.base_project.base.RxxBus.HttpResponse;
        ...
        return httpResponseFlowable ->
                httpResponseFlowable.flatMap((Function<HttpResponse<T>, Flowable<T>>) httpResponse -> {
                    if (httpResponse.code == 0) {
                        ...
                        return Flowable.error(new ApiException("Máy chủ trả về lỗi"));
                    } else {
                        return Flowable.error(new ApiException("Máy chủ trả về lỗi"));
                    }
                });
